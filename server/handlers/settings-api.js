...
async function handleSettingsAPI(req, res) {
  ...
  if (!token) {
    return httpUtils.sendJson(res, 401, {
      success: false,
  ...
  try {
    ...
    if (result && result.length > 0) {
      return {
        ...
        businessEmail:
          result[0].business_email || "Roy.Turner@tnrbusinesssolutions.com",
        businessPhone: result[0].business_phone || "(412) 499-2987",
        businessAddress:
          result[0].business_address ||
          "418 Concord Avenue, Greensburg, PA 15601",
      };
    }
...
async function saveSettings(settingsData) {
  try {
    ...
    return {
      ...
      businessEmail:
        settingsData.businessEmail || "Roy.Turner@tnrbusinesssolutions.com",
